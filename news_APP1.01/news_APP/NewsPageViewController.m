...
//@property (nonatomic ,strong) NSArray *collectionViewTitle;                               //模拟头部数据
@property (nonatomic ,strong) NewsTableViewController * tableViewController;//内容tableVC

@property (nonatomic ,strong) NSArray *linshiModels;                        //临时设置，为了翻页时候再次给tableview赋值
